...
/*
  ...
  Content-Security-Policy: frame-ancestors *; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://api.deepseek.com https://esm.run https://cdn.jsdelivr.net https://static.cloudflareinsights.com; connect-src 'self' https://api.deepseek.com https://api.minimax.chat https://static.cloudflareinsights.com https://esm.run https://cdn.jsdelivr.net; worker-src 'self' blob:; img-src 'self' data: https:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com
